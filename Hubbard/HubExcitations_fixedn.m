...
if usesave && exist([datafldr,'/',name],'file')==2
    ...
    disp('ground state');
    [E0,k0,rho_c] = fHUBGS_fixedn(U,n,tol,verbose);
    [mu,Emu] = fHUB_mu_from_n(U,n,tol,rho_c,k0,verbose);
    [Etmp,n,ktmp,Edr_c,Edr_s,rho_ctmp,rho_s] = fHUBGS_fixedmu(U,mu,tol,verbose,k0);
    disp('done');
